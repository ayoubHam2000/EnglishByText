...
class D_filter_word_list(
    ...
    private fun getValues(){
        for(i in 0..2){
            ...
            if(getItemAt(1, i).isChecked) filterData.hasDefinition = FilterData.getOptionType(i)
            if(getItemAt(2, i).isChecked) filterData.hasExample = FilterData.getOptionType(i)
            if(getItemAt(3, i).isChecked) filterData.hasImage = FilterData.getOptionType(i)
            if(getItemAt(4, i).isChecked) filterData.hasAudio = FilterData.getOptionType(i)
            if(getItemAt(5, i).isChecked) filterData.hasTag = FilterData.getOptionType(i)
            if(getItemAt(6, i).isChecked) filterData.hasFolder = FilterData.getOptionType(i)
            if(getItemAt(7, i).isChecked) filterData.hasText = FilterData.getOptionType(i)
        }
    ...
    private fun setValues(){
        for(i in 0..2){
            ...
            if(filterData.hasDefinition == FilterData.getOptionType(i)) getItemAt(1, i).isChecked = true
            if(filterData.hasExample == FilterData.getOptionType(i)) getItemAt(2, i).isChecked = true
            if(filterData.hasImage == FilterData.getOptionType(i)) getItemAt(3, i).isChecked = true
            if(filterData.hasAudio == FilterData.getOptionType(i)) getItemAt(4, i).isChecked = true
            if(filterData.hasTag == FilterData.getOptionType(i)) getItemAt(5, i).isChecked = true
            if(filterData.hasFolder == FilterData.getOptionType(i)) getItemAt(6, i).isChecked = true
            if(filterData.hasText == FilterData.getOptionType(i)) getItemAt(7, i).isChecked = true
        }
